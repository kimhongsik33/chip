...
public class BNBETHMonitor {
    ...
    public void onOpen(Session session) {
    	System.out.println("[BNBETHMonitor.onOpen()]");
    ...
    public void onMessage(String data) throws JSONException {
        ...
        JsonInfoStorage.BNBETHDealTime = timeStamp;
        JsonInfoStorage.BNBETHSymbol = symbol;
        ...
        if(bidValues.length() > 0){
        	...
        	if (bidQuantity > 0){
        		JsonInfoStorage.BNBETHbidPrice = bidPrice;
        		JsonInfoStorage.BNBETHbidQuantity = bidQuantity;
        ...
        if (askValues.length() > 0){
        	...
        	if (askQuantity > 0){
        		JsonInfoStorage.BNBETHaskPrice = askPrice;
        		JsonInfoStorage.BNBETHaskQuantity = askQuantity;
        		ArbitrageOutput.calcArbitrage(symbol);
        	}
        }
    }
